...
plt.title(f'配信サイト数と平均週間ツイートユーザ数の散布図\nピアソンの相関係数: {correlation_coefficient:.2f}')
plt.legend()

plt.savefig("plot_mean_tweet_user_broadcaster_stream.png")
...
# CSVとして保存する
result_df.to_csv('plot_mean_tweet_user_broadcaster_stream.csv', index=False)
