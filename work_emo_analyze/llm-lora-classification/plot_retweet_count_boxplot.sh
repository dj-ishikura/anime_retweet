...
tweet_object_dir="/work/n213304/learn/anime_retweet_2/retweet_count"
tweet_emo_dir="./prediction"
output_dir="retweet_count_boxplot"
mkdir -p $output_dir
...
for tweet_emo_file in $tweet_emo_dir/*.json; do
    ...
    if [ ! -f "$output_png" ]; then
        ...
        J=$id M=$mem qcmd python src/plot_retweet_count_boxplot.py $tweet_object_file $tweet_emo_file $output_png $id
        sleep 1
    fi
done
