...
input_dir="/work/n213304/learn/anime_retweet_2/anime_retweet_concat"
output_dir="tweet_user_profile_all_works"
mkdir -p $output_dir
...
for input_file in $input_dir/*.csv; do
    ...
    if [ ! -f "$output_jsonl" ]; then
        ...
        J=$id M=$mem qcmd python ./src/get_tweet_user_profile.py $input_file $output_jsonl $id
        sleep 1
    fi
done
