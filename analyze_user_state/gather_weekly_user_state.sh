...
input_dir="/work/n213304/learn/anime_retweet_2/anime_tweet_concat"
output_dir="weekly_user_state"
mkdir -p $output_dir
...
for input_file in $input_dir/*.csv; do
    ...
    if [ ! -f "$output_csv" ]; then
        ...
        J=$id M=$mem qcmd python ./src/get_weekly_user_state.py $input_file $output_csv $id
        sleep 1
        break
    fi
done
